...
export MODEL_NAME="Meta-Llama-3-8B-instruct_prune_lora"
export MODEL_PATH="/home/thsch026/masterarbeit/models/generated/prune_plus_lora/shortened-llm/Meta-Llama-3-8B-instruct_prune_lora"
#export MODEL_NAME=Meta-Llama-3-8B-Instruct_prune_2xlora
...
python src/lora_retrain.py \
    ...
    --data_path saillab/alpaca_german_taco \
