...
CKPT_TYPE="toms"
CKPT_NAME="Mistral-7B-Instruct-v02_prune_lora"
CKPT_PATH="${BASE_PATH}/model_hub/${CKPT_TYPE}/${CKPT_NAME}"
TEACHER_MODEL_TYPE="mistral"
TEACHER_MODEL_NAME="mistral-7b-instruct-v0.2"
TEACHER_MODEL_PATH="${BASE_PATH}/model_hub/${TEACHER_MODEL_TYPE}/${TEACHER_MODEL_NAME}"
TEACHER_PEFT_PATH="/home/thsch026/masterarbeit/experiment/DSKD/outputs/mistral/mistral-7b-instruct-v0.2/sft/adapter"
