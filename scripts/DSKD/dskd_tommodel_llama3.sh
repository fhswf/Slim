...
# model
BASE_PATH="/home/thsch026/masterarbeit/experiment/DSKD"
CKPT_TYPE="toms"
CKPT_NAME="Meta-Llama-3-8B-instruct_prune_lora"
CKPT_PATH="${BASE_PATH}/model_hub/${CKPT_TYPE}/${CKPT_NAME}"
TEACHER_MODEL_TYPE="toms"
TEACHER_MODEL_NAME="Meta-Llama-3-8B-Instruct"
TEACHER_MODEL_PATH="${BASE_PATH}/model_hub/${TEACHER_MODEL_TYPE}/${TEACHER_MODEL_NAME}"
TEACHER_PEFT_PATH="/home/thsch026/masterarbeit/experiment/DSKD/outputs/toms/Meta-Llama-3-8B-Instruct/sft/adapter"
# data
