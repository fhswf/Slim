...
TEACHER_MODEL_NAME="Phi-3-medium-4k-instruct"
TEACHER_MODEL_PATH="${BASE_PATH}/model_hub/${TEACHER_MODEL_TYPE}/${TEACHER_MODEL_NAME}"
TEACHER_PEFT_PATH="/home/thsch026/masterarbeit/experiment/DSKD/outputs/toms/Phi-3-medium-4k-instruct/sft/adapter"
# data
